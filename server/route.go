...
import (
	...
	"github.com/djkormo/simple-ingress-controller/controllers"
...
func NewRoutingTable(payload *controllers.Payload) *RoutingTable {
	rt := &RoutingTable{
...
func (rt *RoutingTable) init(payload *controllers.Payload) {
	if payload == nil {
		return
	}
...
func (rt *RoutingTable) addBackend(ingressPayload controllers.IngressPayload, rule networking.IngressRule) {
...
func (rt *RoutingTable) getServicePort(ingressPayload controllers.IngressPayload, serviceName string, servicePort intstr.IntOrString) int {
